...
<div class="centmenudiv">
	<ol class="centmenu" id="centmenu">
    	<li><a href="#1" onClick="set_menu3(0)" class="current">工作台维护</a></li>
    </ol>
</div>

<div class="toolBox" style="margin-top:15px; width:97.5%; margin-left:15px;">
	<a href="#1" class="cur22" onClick="showtsBoxt5()">新增工作台</a>
	<a href="#1" class="cur3" onClick="getDetail()">修改</a>
	<a href="#1" class="cur4" onClick="delPlatformAfter()">删除</a>
</div>
<div class="ptx"></div>
<div class="xttabBox">
...
<div class="simaltBoxt5" id="simaltBoxt5">
	<div class="simaltBoxst5">
		<div class="tctitle">新增工作台<a href="#1" onClick="hidetsBoxt5()" title="关闭"></a></div>
		<table class="ggtab  ml5 mt5"  width="100%" cellpadding="0" cellspacing="0">
			<tr height="65">
				<td align="right" width="85"><label class="xin">工作台：</label></td>
                <td>
                	<input type="text" class="xtzwwhtext"/><p class="errormsg2"  id="platformInputMsg5"></p>
                </td>
			</tr>
			<tr height="65">
		...
		<div class="jgtcbutBox" align="center">
        	<input type="button" class="yes mt15" value="确认" onClick="addPlatform()">
...
<div class="simaltBoxt5" id="simaltBoxt6">
	<div class="simaltBoxst5">
		<div class="tctitle">修改工作台<a href="#1" onClick="hidetsBoxt6()" title="关闭"></a></div>
		<input type="hidden" value=""/>
		<table class="ggtab  ml5 mt5"  width="100%" cellpadding="0" cellspacing="0">
			<tr height="65">
				<td align="right" width="85"><label class="xin">工作台：</label></td>
                <td>
					<input type="text" class="xtzwwhtext"/><p class="errormsg2" id="platformInputMsg6"></p>
				</td>
			</tr>
			<tr height="65">
				<td align="right"><label>描述：</label></td>
...
<script type="text/javascript" src="/pages/js/system/workplatform/platform.js"></script>
